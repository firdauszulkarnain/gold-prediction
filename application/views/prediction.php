                        ...
                        <div class="row mt-5 d-flex justify-content-center">
                            <div class="col-lg-10">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="data_h2">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="data_h1" class="col-sm-4 col-form-label">Masukan Data H-1</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="data_h1">
                                    </div>
                                </div>
                                <button class="btn btn-warning font-weight-bolder px-5 mt-4 rounded-pill float-right mb-5">Prediksi</button>
                            </div>
                        </div>
                    </form>
                </div>
